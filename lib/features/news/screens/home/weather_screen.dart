...
class _WeatherScreenState extends State<WeatherScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slideAnimation = Tween<double>(begin: 200, end: 0).animate(_animationController);
    _fadeAnimation = Tween<double>(begin: 0.1, end: 1).animate(_animationController);
            ...
            child: Column(
              ...
              children: [
                ...
                WeatherDegreeDetails(
                  ...
                  currentWeatherData: homeController.getData().getCurrentWeather(),
                ),
